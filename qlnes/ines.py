...
SUPPORTED_MAPPERS = (0, 1, 2, 3, 4, 5, 7, 9, 10, 11, 13, 16, 18, 19, 21, 22, 23, 24, 25, 26, 32, 33, 34, 42, 66, 69, 70, 71, 72, 78, 79, 85, 87, 101, 206)
...
def rom_to_images(data: bytes) -> list[tuple[int, bytes]]:
    ...
    if h.mapper in (5, 18, 19, 21, 22, 23, 24, 25, 26, 32, 33, 69, 85):
