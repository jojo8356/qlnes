...
def _runtime_sprite_test_rom() -> bytes:
    code = [
        ...
        0x8D,
        0x01,
        0x02,  # sprite0 tile=$00
        0xA9,
        0x00,
        0x8D,
        0x02,
        0x02,  # sprite0 attr palette 0
        0xA9,
        0x0C,
        0x8D,
        0x03,
        ...
        0xAD,
        0x02,
        0x20,  # LDA PPUSTATUS (reset addr latch)
        0xA9,
        0x3F,
        0x8D,
        0x06,
        0x20,  # PPUADDR high $3F
        0xA9,
        0x10,
        0x8D,
        0x06,
    ...
    code.extend(
        [
            ...
            0x8D,
            0x00,
            0x20,  # PPUCTRL: NMI on, sprite PT1
            0xA9,
            0x1E,
            0x8D,
            0x01,
...
def _runtime_prg_ram_oamdma_sprite_test_rom() -> bytes:
    code = [
        ...
        0x9D,
        0x00,
        0x60,  # fill_prg_ram_oam: STA $6000,X
        0xE8,  # INX
        0xD0,
        0xFA,  # BNE fill_prg_ram_oam
        0xA9,
        0x14,
        0x8D,
        0x00,
        ...
        0x8D,
        0x01,
        0x60,  # sprite0 tile=$00
        0xA9,
        0x00,
        0x8D,
        0x02,
        0x60,  # sprite0 attr palette 0
        0xA9,
        0x0C,
        0x8D,
        0x03,
...
def _runtime_cprom_chr_ram_sprite_test_rom() -> bytes:
    ...
    code = [
        ...
        0x8D,
        0x00,
        0x80,  # CPROM CHR-RAM bank 2 at $1000-$1FFF
        0xA2,
        0x00,
        0xA9,
        0xF8,
...
def _runtime_uxrom_sprite_test_rom() -> bytes:
    ...
    reset = [
        ...
        0x8D,
        0x00,
        0x80,  # select switchable PRG bank 1
        0x4C,
        0x00,
        0x80,  # JMP $8000 in selected bank
    ]
...
def _runtime_gxrom_sprite_test_rom() -> bytes:
    ...
    reset = [
        ...
        0x8D,
        0x00,
        0x80,  # select PRG bank 1 and CHR bank 1
        0x4C,
        0x00,
        0x80,  # JMP $8000 in selected PRG bank
    ]
...
def _runtime_colordreams_sprite_test_rom() -> bytes:
    ...
    reset = [
        ...
        0x8D,
        0x00,
        0x80,  # select PRG bank 1 and CHR bank 2
        0x4C,
        0x00,
        0x80,
    ]
...
def _runtime_mmc1_sprite_test_rom() -> bytes:
    ...
    reset = [
        ...
        0x8D,
        0x00,
        0x80,  # reset MMC1 shift register
    ]
...
def _runtime_mmc3_sprite_test_rom() -> bytes:
    ...
    reset = [
        ...
        0x8D,
        0x00,
        0x80,  # MMC3 select R2, maps $1000-$13FF
        0xA9,
        0x07,
        0x8D,
        0x01,
        0x80,  # CHR 1 KiB bank 7
        0xA9,
        0x06,
        0x8D,
        0x00,
        0x80,  # select R6 PRG window $8000-$9FFF
        0xA9,
        0x01,
        0x8D,
        0x01,
        0x80,  # switch PRG bank 1 there
        0x4C,
        0x00,
        0x80,
    ]
...
def _runtime_rambo1_sprite_test_rom() -> bytes:
    ...
    reset = [
        ...
        0x8D,
        0x00,
        0x80,  # K=1, select CHR R2 at PPU $1000-$13FF
        0xA9,
        0x1B,
        0x8D,
        0x01,
        0x80,  # CHR 1 KiB bank $1B
        0xA9,
        0x06,
        0x8D,
        0x00,
        0x80,  # select PRG R6 at CPU $8000-$9FFF
        0xA9,
        0x04,
        0x8D,
        0x01,
...
def _runtime_fme7_sprite_test_rom() -> bytes:
    ...
    reset = [
        ...
        0x8D,
        0x00,
        0x80,  # FME-7 command 4: CHR slot $1000-$13FF
        0xA9,
        0x07,
        0x8D,
        0x00,
        0xA0,  # map CHR 1 KiB bank 7 there
        0xA9,
        0x09,
        0x8D,
        0x00,
        0x80,  # FME-7 command 9: PRG window $8000-$9FFF
        0xA9,
        0x01,
        0x8D,
        0x00,
        0xA0,  # switch PRG bank 1 there
        0x4C,
        0x00,
        0x80,
    ]
...
def _runtime_mmc5_sprite_test_rom() -> bytes:
    ...
    reset = [
        ...
        0x8D,
        0x00,
        0x51,  # PRG mode 3: four 8 KiB windows
        0xA9,
        0x03,
        0x8D,
        0x01,
        0x51,  # CHR mode 3: eight 1 KiB windows
        0xA9,
        0x1B,
        0x8D,
        0x24,
        0x51,  # CHR slot 4 ($1000-$13FF) = bank $1B
        0xA9,
        0x84,
        0x8D,
        0x14,
        0x51,  # PRG slot $8000 = ROM bank 4
        0x4C,
        0x00,
        0x80,
    ]
...
def _runtime_vrc6_sprite_test_rom() -> bytes:
    ...
    reset = [
        ...
        0x8D,
        0x03,
        0xB0,  # VRC6 commercial CHR banking style 0
        0xA9,
        0x1B,
        0x8D,
        0x00,
        0xE0,  # CHR slot 4 ($1000-$13FF) = bank $1B
        0xA9,
        0x02,
        0x8D,
        0x00,
        0x80,  # 16 KiB PRG slot $8000 = bank pair 4/5
        0x4C,
        0x00,
        0x80,
    ]
...
def _runtime_vrc4_sprite_test_rom() -> bytes:
    ...
    reset = [
        ...
        0x8D,
        0x00,
        0xD0,  # CHR slot 4 low nibble
        0xA9,
        0x01,
        0x8D,
        0x01,
        0xD0,  # CHR slot 4 high bits -> bank $1B
        0xA9,
        0x04,
        0x8D,
        0x00,
        0x80,  # PRG slot $8000 = bank 4
        0x4C,
        0x00,
        0x80,
    ]
...
def _runtime_vrc7_sprite_test_rom() -> bytes:
    ...
    reset = [
        ...
        0x8D,
        0x00,
        0xC0,  # CHR slot 4 ($1000-$13FF) = bank $1B
        0xA9,
        0x04,
        0x8D,
        0x00,
...
def _runtime_mapper206_sprite_test_rom() -> bytes:
    ...
    reset = [
        ...
        0x8D,
        0x00,
        0x80,  # select CHR register 2, PPU $1000-$13FF
        0xA9,
        0x07,
        0x8D,
        0x01,
        ...
        0x8D,
        0x00,
        0x80,  # select PRG register 6, CPU $8000-$9FFF
        0xA9,
        0x01,
        0x8D,
        0x01,
...
def _runtime_mapper34_nina_sprite_test_rom() -> bytes:
    ...
    reset = [
        ...
        0x8D,
        0xFF,
        0x7F,  # NINA CHR bank 3 at PPU $1000-$1FFF
        0xA9,
        0x01,
        0x8D,
        0xFD,
        0x7F,  # switch 32 KiB PRG bank 1
        0x4C,
        0x00,
        0x82,
    ]
...
def _runtime_mapper42_sprite_test_rom() -> bytes:
    ...
    reset = [
        ...
        0x8D,
        0x00,
        0x80,  # CHR bank 2 at PPU $0000-$1FFF
        0x4C,
        0x00,
        0x80,
    ]
...
def _runtime_mmc2_sprite_test_rom() -> bytes:
    ...
    reset = [
        ...
        0x8D,
        0x00,
        0xB0,  # CHR latch 0 FD = bank 1
        0xA9,
        0x03,
        0x8D,
        0x00,
        0xD0,  # CHR latch 1 FD = bank 3
        0xA9,
        0x02,
        0x8D,
        0x00,
        0xA0,  # PRG bank 2 at $8000-$9FFF
        0x4C,
        0x00,
        0x80,
    ]
...
def _runtime_mapper16_sprite_test_rom() -> bytes:
    ...
    reset = [
        ...
        0x8D,
        0x04,
        0x60,  # CHR slot 4 ($1000-$13FF) = 1 KiB bank 5
        0xA9,
        0x02,
        0x8D,
        0x08,
        0x60,  # PRG bank 2 at $8000-$BFFF
        0x4C,
        0x00,
        0x80,
    ]
...
def _runtime_mapper18_sprite_test_rom() -> bytes:
    ...
    reset = [
        ...
        0x8D,
        0x00,
        0xC0,  # CHR slot 4 low nibble = $B
        0xA9,
        0x01,
        0x8D,
        0x01,
        0xC0,  # CHR slot 4 high nibble = $1 -> bank $1B
        0xA9,
        0x04,
        0x8D,
        0x00,
        0x80,  # PRG slot $8000 low nibble = 4
        0xA9,
        0x00,
        0x8D,
        0x01,
        0x80,  # PRG slot $8000 high bits = 0
        0x4C,
        0x00,
        0x80,
    ]
...
def _runtime_mapper19_sprite_test_rom() -> bytes:
    ...
    reset = [
        ...
        0x8D,
        0x00,
        0xA0,  # CHR slot 4 ($1000-$13FF) = 1 KiB bank $1B
        0xA9,
        0x04,
        0x8D,
        0x00,
        0xE0,  # PRG slot $8000 = bank 4
        0x4C,
        0x00,
        0x80,
    ]
...
def _runtime_mapper32_sprite_test_rom() -> bytes:
    ...
    reset = [
        ...
        0x8D,
        0x04,
        0xB0,  # CHR slot 4 ($1000-$13FF) = 1 KiB bank $1B
        0xA9,
        0x04,
        0x8D,
        0x00,
...
def _runtime_mapper33_sprite_test_rom() -> bytes:
    ...
    reset = [
        ...
        0x8D,
        0x00,
        0xA0,  # CHR 1 KiB slot $1000-$13FF = bank $1B
        0xA9,
        0x04,
        0x8D,
        0x00,
...
def _runtime_mapper71_sprite_test_rom() -> bytes:
    ...
    reset = [
        ...
        0x8D,
        0x00,
        0xC0,  # select switchable PRG bank 1
        0x4C,
        0x00,
        0x80,
    ]
...
def _runtime_mapper72_sprite_test_rom() -> bytes:
    ...
    reset = [
        ...
        0x8D,
        0x00,
        0x80,  # rising bit 6: CHR bank 3
        0xA9,
        0x03,
        0x8D,
        0x00,
        0x80,  # clear command bits
        0xA9,
        0x82,
        0x8D,
        0x00,
        0x80,  # rising bit 7: PRG bank 2
        0x4C,
        0x00,
        0x80,
    ]
...
def _runtime_mapper75_sprite_test_rom() -> bytes:
    ...
    reset = [
        ...
        0x8D,
        0x00,
        0x90,  # high bit for CHR $1000-$1FFF
        0xA9,
        0x02,
        0x8D,
        0x00,
        0xF0,  # CHR 4 KiB bank $12 at PPU $1000-$1FFF
        0xA9,
        0x04,
        0x8D,
        0x00,
...
def _runtime_mapper78_sprite_test_rom() -> bytes:
    ...
    reset = [
        ...
        0x8D,
        0x00,
        0x80,  # select PRG bank 2 and CHR bank 5
        0x4C,
        0x00,
        0x80,
    ]
...
def _runtime_mapper87_sprite_test_rom() -> bytes:
    code = [
        ...
        0x8D,
        0x00,
        0x60,  # select J87 CHR bank 2: bit0 is high bit
        0xA2,
        0x00,
        0xA9,
        0xF8,
...
def _runtime_mapper101_sprite_test_rom() -> bytes:
    code = [
        ...
        0x8D,
        0x00,
        0x60,  # select JF-10 CHR bank 1: normal bit order
        0xA2,
        0x00,
        0xA9,
        0xF8,
...
class TestSpriteExport(unittest.TestCase):
    ...
    def test_in_process_runtime_sample_export_writes_one_directory_per_frame(self):
        with tempfile.TemporaryDirectory() as td:
            ...
            self.assertEqual(
                data["unique_sprites"][0]["palette_ppu"], ["0x0F", "0x30", "0x16", "0x27"]
            )
    ...
    def test_cli_sprites_batch_runtime_sample_frames(self):
        with tempfile.TemporaryDirectory() as td:
            ...
            self.assertEqual(rc, 0)
            self.assertTrue((out_dir / "ok" / "frame-000001" / "oam-spritesheet.png").exists())
            data = json.loads((out_dir / "sprites-batch-manifest.json").read_text())
            ...
            self.assertEqual(atlas["sprite_count"], 1)
            self.assertEqual(
                atlas["spritesheet"], str(out_dir / "all-unique-trimmed-spritesheet.png")
            )
